...
public class airports extends javax.swing.JFrame {
    ...
    public airports() {
        ...
        Object[] column = {"Sr.", "Name", "Location", "Contact Number"};
    ...
    private void loadTable() {
        try {
            ResultSet rs = databaseConnection.retriveQuery("Select * from airport");
            model.setRowCount(0);
            Object[] row = new Object[5];
            int count = 1;
            while (rs.next()) {
                System.out.println("Addiding id : " + rs.getInt(1));
                ids.add(rs.getInt(1));
                row[0] = count++;
    ...
    private boolean validData() {
        if (this.name.getText().equals("")) {
            ...
            return false;
        } else if (this.location.getText().equals("")) {
            error.setText("Last Name Can't be Null");
            return false;
        } else if (this.contactNumber.getText().equals("")) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Airports Data Modification");
        ...
        jButton1.addMouseListener(new java.awt.eent.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            ...
                                            .addComponent(location, javax.swing.GroupLayout.PREFERRED_SIZE, 223, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addMouseClicked
        ...
        if (add.isEnabled() == true) {
            if (validData()) {
                ...
                if (databaseConnection.addNewAirport(this.name.getText(), this.location.getText(), this.contactNumber.getText())) {
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        if (this.delete.isEnabled()) {
            if (databaseConnection.update_Delete_Query("DELETE FROM `flight_booking_system`.`airport` WHERE (`airportId` = '" + this.ids.get(table.getSelectedRow()) + "');")) {
    ...
    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        if (this.update.isEnabled()) {
            if (this.validData()) {
                if (databaseConnection.update_Delete_Query("UPDATE `flight_booking_system`.`airport` SET `Name` = '" + this.name.getText() + "', `location` = '" + this.location.getText() + "', `contactNumber` = '" + this.contactNumber.getText() + "' WHERE (`airportId` = '" + this.id.getText() + "');")) {
